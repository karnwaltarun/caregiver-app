...
public class CalServiceProxy implements webservice.CalService {
  private String _endpoint = null;
  private webservice.CalService calService = null;
  ...
  private void _initCalServiceProxy() {
    try {
      calService = (new webservice.CalServiceServiceLocator()).getCalService();
      if (calService != null) {
        if (_endpoint != null)
  ...
  public webservice.CalService getCalService() {
    if (calService == null)
      _initCalServiceProxy();
    return calService;
  }
